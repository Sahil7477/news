...
const MainContent = () => {
  ...
  const mainStory = {
    id: 1,
    title: "২২ গজে শুভমন, দর্শকাসনে রোহিত! ওভালে লাঞ্চ বিরতির আগে দাপটে ভারত, স্কোর কত?",
    image: "/api/placeholder/600/400",
    description: "সদ্য তিনি নিয়েছেন টেস্ট থেকে অবসর। তা ঘিরে ক্রিকেটপ্রেমীদের কৌতূহল, প্রশ্ন, জল্পনা আজও চলছে! এরই মাঝে ভারত বনাম ইংল্যান্ড পঞ্চম টেস্টের রুদ্ধশ্বাস তৃতীয় দিনে ওভাল-এ রোহিত শর্মা।",
  ...
  const secondaryNews = [
    ...
    },
    {
      ...
      image: "/api/placeholder/300/200",
      description: "ডিজিটাল যুগের সাথে তাল মিলিয়ে শিক্ষাব্যবস্থায় আমূল পরিবর্তন",
  ...
  const filteredNews = activeCategory === "all" 
    ...
    : secondaryNews.filter(news => {
        switch(activeCategory) {
          case "cricket": return news.category === "ক্রিকেট";
          case "health": return news.category === "স্বাস্থ্য";
          case "society": return news.category === "সমাজ";
          case "education": return news.category === "শিক্ষা";
          case "entertainment": return news.category === "বিনোদন";
          case "kolkata": return news.category === "কলকাতা";
          default: return true;
        }
      });
  ...
  const sortedNews = [...filteredNews].sort((a, b) => {
    switch(sortBy) {
      ...
      case "commented": return b.comments - a.comments;
      case "latest":
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm" className="font-bengali">
                  ...
                  {sortBy === "latest" ? "সর্বশেষ" : sortBy === "popular" ? "জনপ্রিয়" : "আলোচিত"}
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent className="bg-white border border-gray-200 shadow-lg z-50">
                <DropdownMenuItem onClick={() => setSortBy("latest")} className="font-bengali">
                  <Clock className="w-4 h-4 mr-2" />
                  সর্বশেষ
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSortBy("popular")} className="font-bengali">
                  <TrendingUp className="w-4 h-4 mr-2" />
                  জনপ্রিয়
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSortBy("commented")} className="font-bengali">
                  আলোচিত
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
      ...
      <section className="mt-12 bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {secondaryNews.slice(0, 3).map((news) => (
            <div key={`related-${news.id}`} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
              <Image src={news.image} alt={news.title} className="w-full h-32 object-cover" />
              <div className="p-3">
                ...
                <div className="flex items-center justify-between mt-2 text-xs text-meta-text">
                  <Badge variant="secondary" className="font-bengali">{news.category}</Badge>
