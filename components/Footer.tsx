      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-4">
              <div className="text-xl font-bold">
                <span className="font-english text-white">Sangbad</span>
                
              </div>
              <div className="text-2xl font-bold text-news-red font-bengali">Bangla</div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="font-english">Email: xyzexample@gmail.com</li>
              <li className="font-english">Phone: +91 1234567890</li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-sm font-english">
            © 2025 Sangbad Bangla. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
